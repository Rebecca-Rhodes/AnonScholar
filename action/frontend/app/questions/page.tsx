          ...
          <div className="flex items-center justify-between">
            ...
            {isDecrypted && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  console.log("🔘 Answer button clicked for question:", question.id);
                  console.log("🔘 Current showAnswerForm state:", showAnswerForm);
                  setShowAnswerForm(question.id);
                  console.log("🔘 Setting showAnswerForm to:", question.id);
                }}
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  console.log("🔘 Add Answer button clicked for question:", question.id);
                  console.log("🔘 Current showAnswerForm state:", showAnswerForm);
                  setShowAnswerForm(question.id);
                  console.log("🔘 Setting showAnswerForm to:", question.id);
                }}
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        {showAnswerForm !== null && (
          <>
            {console.log("📝 Rendering answer form for question:", showAnswerForm)}
            {renderAnswerForm(showAnswerForm)}
          </>
        )}
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-3">
            <button
              onClick={() => anonScholar.loadQuestions()}
        ...
        <div className="space-y-4">
          {anonScholar.questions.length > 0 ? (
